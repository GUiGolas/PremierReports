<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GraphicsForm.aspx.cs" Inherits="PremierReports_v_1_0.GraphicsForm" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<body class="metro">
    <form id="form1" runat="server" defaultbutton="bntReportSubmit">
                    ...
                    <tr>
                        <td>
                            <table style="font: inherit; color: inherit; background-color: transparent;">
                                <tr>
                                    <td>
                                        <asp:Label ID="lblDateIniG" runat="server" Text="Data Inicial: *" meta:resourcekey="lblDateIniGResource1"></asp:Label>
                                    </td>
                                    <td>
                        ...
                        <td>
                            <table style="background-color: transparent;">
                                <tr>
                                    <td>
                                        <asp:Label ID="lblAddEventsR" style="padding-left: 40px; padding-top: 10px;" runat="server" Text="Eventos:" meta:resourcekey="lblAddEventsRResource1"></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        <asp:ListBox ID="lsbEvents" runat="server" BackColor="White" Enabled="False" Height="55px" SelectionMode="Multiple" Width="200px" meta:resourcekey="lsbEventsResource1"></asp:ListBox>
                                        <br />
                                ...
                                <tr>
                                    <td>
                                        <asp:Label Text="Tipo de Gráfico: " ID="lblChartType" runat="server" meta:resourcekey="lblChartTypeResource1" />
                                    </td>
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlChartType" meta:resourcekey="ddlChartTypeResource1">                                            
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
        ...
        <div>
            <asp:Chart ID="ReportChart" runat="server" Height="480px" Width="995px" Visible="False" meta:resourcekey="ReportChartResource1">
                <Series>
        ...
        <%-- <div id="GraphicShow">
            <asp:Chart ID="GraphicChart" runat="server">
                <Series>
                    <asp:Series Name="Series1"></asp:Series>
                </Series>
                <ChartAreas>
